package com.cloudbees.management.PaaSFrontEnd.HAProxy;

import com.cloudbees.management.PaaSFrontEnd.*;
import com.cloudbees.management.PaaSFrontEnd.HAProxy.Impl.HAProxyRegistry;
    ...
    public static void main(String[] args)
     {
         if (args.length < 1)
         {
             System.out.println("Usage: com.cloudbees.management.PaaSFrontEnd.PaaSFrontEnd.HAProxyConfiguration defaultConfigurationFile");
             System.exit(2);
         }
         HAProxyConfiguration lbc;
         try {
             lbc = new HAProxyConfiguration(args[0]);

             PaaSApplication app1 = new PaaSApplication("company1.highstor.com/company1/", PaaSApplication.COOKIE, PaaSApplication.HTTP | PaaSApplication.HTTPS);
             ...
             PaaSApplication app2 = new PaaSApplication("company2.highstor.com/company2/", PaaSApplication.NON_STICKY, PaaSApplication.HTTP);
             ...
             PaaSApplication app3 = new PaaSApplication("company3.highstor.com/company3/", PaaSApplication.COOKIE | PaaSApplication.SOURCE_IP, PaaSApplication.HTTPS);
...
/*
             "{\"app1.cloudbees.com\":{\"backends\":[\"http://ipinternal.compute1:8080/app1\"],\"ssl\":\"false\",\"sticky\":\"false\"},\n" +
                     "\"app2.cloudbees.com\":{\"backends\":[\"http://ipinternal.compute1:8081/app2\",\"http://ipinternal.compute2:8080/app2\n" +
                     "weight=2\"],\"ssl\":\"true\",\"sticky\":\"true\"}}");
*/
